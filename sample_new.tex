...
\begin{figure}
        ...
        See figure \ref{fig:legends} for the legend of the shapes}\label{fig:visrrts}
\end{figure}

\begin{figure}
        \centering
        \includegraphics[width=3in]{fig/legends}
        \caption{Legend for figure \ref{fig:visrrts}}\label{fig:legends}
\end{figure}
